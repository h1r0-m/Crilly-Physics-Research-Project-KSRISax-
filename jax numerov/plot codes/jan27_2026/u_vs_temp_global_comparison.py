...
def main():
    ...
    temp_array = jnp.logspace(-1,2, num = 30)
    r_box = 30
    Z = 1
    r_start = 1e-5
    N_points = 300
    ...
    for temp in temp_array:
        ...
        U = U_solver_corrected(e,m,d,r_box, r_start, N_points, mu, temp, Z)
    ...
    plt.title(f"Internal Energy vs Temperature (r_box={r_box}, N_points={N_points}, Z={Z})")
    plt.legend()
    plt.grid(True)
    ...
    temp_filename = os.path.join(plot_dir, f"u_vs_temp_global_comparison_rbox{r_box}_N{N_points}_Z{Z}.png")
