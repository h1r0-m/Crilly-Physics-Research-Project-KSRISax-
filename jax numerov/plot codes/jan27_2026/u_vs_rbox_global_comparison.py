...
def main():
    ...
    plt.title(f"Internal Energy vs r_box (Global) (T={T_ha*315775:.0f} K, N_points={N_points}, Z={Z})")
    plt.legend()
    plt.grid(True)
    ...
    temp_filename = os.path.join(plot_dir, f"u_vs_rbox_global_comparison_T{T_ha}_N{N_points}_Z{Z}.png")
